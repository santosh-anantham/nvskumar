        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8 flex flex-col items-center">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              Versatile Software Engineer and Frontend Developer with expertise
              in React.js, JavaScript, and Node.js. Experienced in building
              responsive web applications and contributing to full-stack
              development. Passionate about clean code, intuitive user
              interfaces, and collaborating across teams to deliver impactful
              digital solutions. Strong interest in learning, innovation, and
              delivering high-quality products from concept to deployment.
            </p>
          </div>
